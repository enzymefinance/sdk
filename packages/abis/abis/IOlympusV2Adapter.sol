...
interface IOlympusV2Adapter {
    ...
    function getOhmToken() external view returns (address ohmToken_);
    function getOlympusV2StakingContract() external view returns (address stakingContract_);
    function getSohmToken() external view returns (address sohmToken_);
