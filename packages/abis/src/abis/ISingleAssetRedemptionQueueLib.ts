export const ISingleAssetRedemptionQueueLib = [
  {
    type: "constructor",
    inputs: [
      {
  ...
  {
    type: "function",
    name: "getBypassableSharesThreshold",
    inputs: [],
    outputs: [
      {
        name: "sharesAmount_",
  ...
  {
    type: "function",
    name: "setBypassableSharesThreshold",
    inputs: [
      {
        name: "_nextSharesThreshold",
        type: "uint256",
        internalType: "uint256",
      },
    ],
  ...
  {
    type: "event",
    name: "BypassableSharesThresholdSet",
    inputs: [
      {
        name: "nextSharesAmount",
        type: "uint256",
        indexed: false,
        internalType: "uint256",
      },
