 ...
 */
export class GMXV2LeverageTradingAdditionalInfo extends Message<GMXV2LeverageTradingAdditionalInfo> {
  /**
  ...
  constructor(data?: PartialMessage<GMXV2LeverageTradingAdditionalInfo>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "enzyme.enzyme.v1.GMXV2LeverageTradingAdditionalInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "tracked_assets", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 2, name: "tracked_markets", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GMXV2LeverageTradingAdditionalInfo {
    return new GMXV2LeverageTradingAdditionalInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GMXV2LeverageTradingAdditionalInfo {
    return new GMXV2LeverageTradingAdditionalInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GMXV2LeverageTradingAdditionalInfo {
    return new GMXV2LeverageTradingAdditionalInfo().fromJsonString(jsonString, options);
  }

  static equals(a: GMXV2LeverageTradingAdditionalInfo | PlainMessage<GMXV2LeverageTradingAdditionalInfo> | undefined, b: GMXV2LeverageTradingAdditionalInfo | PlainMessage<GMXV2LeverageTradingAdditionalInfo> | undefined): boolean {
    return proto3.util.equals(GMXV2LeverageTradingAdditionalInfo, a, b);
  }
}
 ...
 */
export class AliceOrderInfo extends Message<AliceOrderInfo> {
  /**
   * Id of the order
   *
   ...
   */
  incomingAssetAddress = "";

  constructor(data?: PartialMessage<AliceOrderInfo>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "enzyme.enzyme.v1.AliceOrderInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "order_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "removed", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 3, name: "removed_at", kind: "message", T: Timestamp },
    { no: 4, name: "outgoing_asset_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "outgoing_asset_amount", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
    { no: 6, name: "incoming_asset_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AliceOrderInfo {
    return new AliceOrderInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AliceOrderInfo {
    return new AliceOrderInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AliceOrderInfo {
    return new AliceOrderInfo().fromJsonString(jsonString, options);
  }

  static equals(a: AliceOrderInfo | PlainMessage<AliceOrderInfo> | undefined, b: AliceOrderInfo | PlainMessage<AliceOrderInfo> | undefined): boolean {
    return proto3.util.equals(AliceOrderInfo, a, b);
  }
}
 ...
 */
export class AliceAdditionalInfo extends Message<AliceAdditionalInfo> {
  /**
  ...
  constructor(data?: PartialMessage<AliceAdditionalInfo>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "enzyme.enzyme.v1.AliceAdditionalInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "orders", kind: "message", T: AliceOrderInfo, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AliceAdditionalInfo {
    return new AliceAdditionalInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AliceAdditionalInfo {
    return new AliceAdditionalInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AliceAdditionalInfo {
    return new AliceAdditionalInfo().fromJsonString(jsonString, options);
  }

  static equals(a: AliceAdditionalInfo | PlainMessage<AliceAdditionalInfo> | undefined, b: AliceAdditionalInfo | PlainMessage<AliceAdditionalInfo> | undefined): boolean {
    return proto3.util.equals(AliceAdditionalInfo, a, b);
  }
}
