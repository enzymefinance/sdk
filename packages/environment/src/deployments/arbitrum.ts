...
export default defineDeployment<Deployment.ARBITRUM>({
  ...
  externalContracts: {
    ...
    gmxV2ExchangeRouter: "0x87d66368cd08a7ca42252f5ab44b2fb6d1fb8d15",
  ...
  releases: {
    [Version.SULU]: {
      ...
      contracts: {
        ...
        GMXV2LeverageTradingPositionLib: "0x42a8aee7d9cd8dfcac4b1881426f91aa813ece50",
        GMXV2LeverageTradingPositionParser: "0xc63ddc23ac51b87a163a0f1458022954a3ac9293",
