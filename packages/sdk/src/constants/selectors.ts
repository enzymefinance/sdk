...
export const LEND_AND_STAKE_SELECTOR = "0x29fa046e"; // lendAndStake(address,bytes,bytes)
export const REDEEM_SELECTOR = "0xc29fa9dd"; // redeem(address,bytes,bytes)
export const STAKE_SELECTOR = "0xfa7dd04d"; // stake(address,bytes,bytes)
export const UNSTAKE_SELECTOR = "0x68e30677"; // unstake(address,bytes,bytes)
export const UNSTAKE_AND_REDEEM_SELECTOR = "0x8334eb99"; // unstakeAndRedeem(address,bytes,bytes)
