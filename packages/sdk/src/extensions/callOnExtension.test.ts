import { ExternalPositionManagerActionId, decodeCallOnExtensionParams, prepareCallOnExtensionParams } from "./callOnExtension.js";
...
test("decode call on extension should work correctly", () => {
  const params = {
    ...
    actionId: 2n as ExternalPositionManagerActionId,
