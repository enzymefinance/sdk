...
test("prepare adapter trade for zeroExV4 take order should work correctly", async () => {
  ...
  // Args hash was taken from tx 0x480356e40b21ef1eab2168d02694efc49ea9de50198d3811db7383fdacfe4e88
  const { signedOrder, takerAssetFillAmount, orderType } = await decodeZeroExV4TakeOrderArgs(callArgs);

  console.log({ signedOrder, takerAssetFillAmount, orderType });
