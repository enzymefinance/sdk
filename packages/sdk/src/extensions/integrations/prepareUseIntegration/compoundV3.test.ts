...
test("prepareUseIntegration for Compound V3 claim rewards should be equal to encoded data with encodeCallArgsForCompoundV3ClaimRewards", () => {
  expect(
    prepareUseIntegration({
      integrationManager: INTEGRATION_MANAGER,
      integrationAdapter: COMPOUND_V3_ADAPTER,
    ...
    `
    {
      ...
      "args": [
        "0x31329024f1a3E4a4B3336E0b1DfA74CC3FEc633e",
        0n,
        "",
      ],
      "functionName": "callOnExtension",
    }
  `,
