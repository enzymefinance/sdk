...
export type LendArgs = {
  ...
  maxUnderlyingAmounts: [bigint, bigint];
  sharesAmount: bigint;
};
...
export function lendDecode(encoded: Hex): LendArgs {
  ...
  return {
    arrakisVault,
    maxUnderlyingAmounts: [...maxUnderlyingAmounts],
    sharesAmount,
  };
}
...
export type RedeemArgs = {
  arrakisVault: Address;
  sharesAmount: bigint;
  minIncomingUnderlyingAmounts: [bigint, bigint];
};
...
export function redeemDecode(encoded: Hex): RedeemArgs {
  ...
  return { arrakisVault, sharesAmount, minIncomingUnderlyingAmounts: [...minIncomingUnderlyingAmounts] };
}
